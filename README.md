...
To use the application, type in the following commands in the GNU/Linux terminal.
...
# Note:
If you find any problems then please write on the issue GitHub and to our Telegram Group. Don't use it for revenge! Make sure you anonymity!
It's made for testing purposes.
We are not responsible for any abuse or damage caused by this program, only for Educational Purposes.
Thanks.
...
For any help, support, payment, suggestions and request ask me on Telegram:
